			...
			<div class="col-md-6 col-xs-12">
				...
				<div class="infomation">
					<ul class="nav nav-tabs">
						<li>
							<p><button type="button" onclick="startorder();" name="button"><i class="fas fa-play-circle"></i> Bắt đầu</button></p>
						</li>
						<li>
							<p> <button type="button" onclick="endup();" id="end" name="button"><i class="fas fa-stop"></i> kết thúc</button></p>
						</li>
						<li>
							<p> <button type="button" onclick="removedt();" name="button"><i class="fas fa-ban"></i> Hủy bàn</button></p>
						</li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<p> <button type="button" name="button"><i class="fas fa-exchange-alt"></i>Chuyển bàn</button></p>
								</li>
								<li>
									<p> <button type="button" name="button"><i class="fab fa-connectdevelop"></i>Ghép bàn</button></p>
								</li>
								<li>
									<p> <button type="button" name="button"><i class="fas fa-minus-square"></i>Tách bàn</button></p>
								</li>
							</ul>
						</li>
					</ul>
