...
INSERT INTO `bill` (`bill_id`, `bill_table`, `bill_employee`, `bill_drinks`, `bill_sale`, `bill_price`, `bill_moneytaked`, `bill_time`) VALUES
(1, '1', 'admin2', 'Cafe Den, RedBull', 0, 22000, 22000, '0000-00-00 00:00:00'),
(2, '2', 'admin2', 'Cafe Den', 0, 10000, 10000, '0000-00-00 00:00:00'),
(3, '1', 'admin2', 'Number1', 0, 11000, 11000, '2018-11-30 15:02:47');
...
(1, 0, 120000, 120000, 'Nhap 2 loc Redbull', '2018-11-30 15:11:48', 'Cua hang tap hoa XYZ', '6/9 Nam ki khoi nghia NHS DN', '090909969');
...
--
ALTER TABLE `thuchi`
  MODIFY `thuchi_id` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
